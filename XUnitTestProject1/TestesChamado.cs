...
namespace XUnitTestProject1
{
    public class TestesChamado : UnitTest1
    {
        ...
        [Fact]
        public void DeverarFalharPosFoiPassadoUmParametrosDiferentesDoEsperadoParaAListagem()
        {
            //arrange
                CriarMock();
            CriarChamadoController();
        ...
        [Fact]
        public void DeveriaRetornarUmChamadoDeExemploQuandoNaoExistirDadosNoBanco()
        {
            //arrange
            CriarMock();
            CriarChamadoController();
